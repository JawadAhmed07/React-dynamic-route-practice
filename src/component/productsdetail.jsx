...
function ProductsDetail() {
    ...
    console.log(id)
// cat title desc thumb price

    return (
        <div className="container mx-auto">
            {
                loading ? (<h1 className="text-center text-3xl">Loading ...</h1>)
                : notFound? (<h1 className="text-center text-3xl">Product not found</h1>)
                :( 
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl underline text-gray-900">
            Price : {product.price}$
          </span>
